...
- E스포츠 소식 페이지 :  224개의 E-스포츠 소식 데이터를 생성했습니다. / 처음에는 sort 메서드를 사용하여 12개의 데이터만 표시되도록 했습니다. / '더보기' 버튼을 클릭하면 나머지 12개의 데이터가 보이고, 이후 '더보기' 버튼이 사라지도록 구현했습니다. / 데이터를 클릭하면 모달 형식으로 유튜브 영상을 보여주도록 했습니다.
